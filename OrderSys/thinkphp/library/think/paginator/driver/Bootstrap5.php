...
class Bootstrap5 extends Paginator
{
    ...
    protected function getLinks()
    {
        ...
        }else if($this->currentPage >= ($this->lastPage-10)){
            $block['first'] = $this->getUrlRange($this->lastPage-10, $this->lastPage);
        }else{
            $n=floor(($this->currentPage+$rollPage-5)/($rollPage-2));
            $start=$n*($rollPage-2)-($rollPage-5);
